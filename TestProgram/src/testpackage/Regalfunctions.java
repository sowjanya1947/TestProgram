...
public class Regalfunctions {
	...
	//LOREN COOK CO - Account name,ExpectedAccountNumber -5000619
	public static  void Login(String Accountname,int ExpectedAccountnum) throws InterruptedException {
		 ...
		 Thread.sleep(12000);	 
		 driver.findElement(By.xpath("//input[@placeholder='Filter by Account # or Name']")).sendKeys("Accountname");
		 Thread.sleep(800);
